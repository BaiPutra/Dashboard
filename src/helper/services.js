...
const getAll = bagian =>
  http.get(`/tiket/${bagian}/${moment().format('YYYY')}-${moment().format('MM')}-01/${moment().format('YYYY')}-${moment().format('MM')}-31`);

const closedTicketLastWeek = () =>
  http.get(`/tiket/closedTicketLastWeek/`);

const performaKanca = bagian =>
  http.get(`/tiket/performaKanca/${bagian}/${moment().format('YYYY')}-${moment().format('MM')}-01/${moment().format('YYYY')}-${moment().format('MM')}-31`);

const performaImplementor = bagian =>
  http.get(`/tiket/performaImplementor/${bagian}/${moment().format('YYYY')}-${moment().format('MM')}-01/${moment().format('YYYY')}-${moment().format('MM')}-31`);

const perTanggal = bagian =>
  http.get(`/tiket/perTanggal/${bagian}`);

const perJenisMasalah = bagian =>
  http.get(`/tiket/perJenisMasalah/${bagian}/${moment().format('YYYY')}-${moment().format('MM')}-01/${moment().format('YYYY')}-${moment().format('MM')}-31`);
